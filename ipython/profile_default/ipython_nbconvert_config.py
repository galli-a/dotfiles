...
# a config file.
# 
# - wrap_text - strip_files_prefix - ipython2python - indent - strip_dollars -
# filter_data_type - posix_path - highlight2html - html2text - citation2latex -
# path2url - comment_lines - add_prompts - ansi2html - get_lines - strip_ansi -
# markdown2html - escape_latex - highlight2latex - markdown2rst - markdown2latex
# - add_anchor - ascii_only - ansi2latex
...
# 
# c.ExtractOutputPreprocessor.extract_output_types = {'png', 'application/pdf', 'svg', 'jpeg'}
